  ...
  return (
    <div className="min-h-screen py-12 flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="container-custom text-center">
        <h1 className="text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Festival Not Found</h1>
        <p className="text-xl text-gray-300 mb-10 max-w-xl mx-auto">
          Sorry, we couldn't find the festival you're looking for.
        </p>
        <Link 
          href="/festivals" 
