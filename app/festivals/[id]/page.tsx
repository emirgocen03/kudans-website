...
const getFestivalData = (id: string): Festival | undefined => {
  ...
  const festivals: Festival[] = [
    ...
    },
    {
      ...
      videos: [
        { title: 'Hip Hop - Evolution', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
        { title: 'Contemporary - Passage', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
        { title: 'Latin - Tradition', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
        { title: 'Street Dance - Urban History', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
        { title: 'Ballet - Heritage', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
        { title: 'Jazz - Origins', src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
      ],
      photos: [
